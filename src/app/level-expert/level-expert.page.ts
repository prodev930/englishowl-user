...
@Component({
  selector: 'app-level-expert',
  templateUrl: './level-expert.page.html',
  styleUrls: ['./level-expert.page.scss'],
})
export class LevelExpertPage implements OnInit {
 
  chapters?: Chapter[];
  tutorials?: Tutorial[];
  users?: User[];
  user_email = '';
  constructor(public tutorialService: TutorialService, private globals: firevariable, private userInfo: userInfo, public router: Router, private userService: UserService, private quiztitle: quiztitle) { }
